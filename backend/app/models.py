"""ORM-модели. Извлечено из main.py (рефакторинг)."""
from enum import Enum as PyEnum
from datetime import datetime
from sqlalchemy import Column, Integer, String, Float, Boolean, Text, Enum as SqlaEnum, LargeBinary as SqlaLargeBinary
